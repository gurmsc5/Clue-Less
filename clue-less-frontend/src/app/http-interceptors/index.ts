...
import {HttpMockPlayerMovementInterceptor} from "./httpmockplayermovementinterceptor";
...
export const httpInterceptorProviders = [
  ...
  { provide: HTTP_INTERCEPTORS, useClass: HttpMockPlayerMovementInterceptor, multi: true }
];
